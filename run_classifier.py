...
class MutliClassClassification(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        """See base class."""
        logger.info("LOOKING AT {}".format(os.path.join(data_dir, "dev_full.tsv")))
        return self._create_examples(self.support, "train")

    def get_dev_examples(self, data_dir):
        """See base class."""
        return self._create_examples(self.queries, "dev")
...
def main():
    ...
    processors = {
        "knowledge_bert": MutliClassClassification
        # "mnli": MnliProcessor,
    ...
    for i in range(100):
        ...
        processor = MutliClassClassification(os.path.join(args.data_dir, "dev_full.tsv"), 5, 100, 5, 700)
    ...
    logger.info("Global Accuracy: %f", global_accuracy/100)
